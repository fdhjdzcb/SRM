...
values  ('11111111', 'Напоминаем вам, что для лучшей производительности нужно и уметь правильно проводить свой отдых. Выключаем телевизор в субботу, в воскресенье выпускаем свой стартап!', '2022-12-12', 'Выходные в декабре', 34, '56e863e8-8aca-442d-9d04-57edd8185b9b.weekend.png'),
        ('11111111', 'Кот Василий блестяще проявил свои таланты в поддержке наших сотрудников в трудные времена. И даже почти не помешал их работе!', '2022-12-12', 'Сотрудник месяца', 35, '0b2b74e4-452d-4854-9b97-f24cc00cc8d8.worker_of_the_month.jpg'),
        ('11111111', 'Напоминаем всем нашим сотрудникам, что вторник - официальный день пиццы в нашей компании. Каждому достанется по своей личной пепперони! Приятного аппетита!', '2022-12-12', 'День пиццы', 36, '73250063-ad26-473f-a98b-771715515985.pepperoni.jpg'),
        ...
        ('11111111', 'Дорогие сотрудники! Напоминаем вам, что работа должна выполняться в том объеме, в котором вас просит начальство! Иначе вас настигнет участь Антона! С уважением, ваш директор, Миленин А.Ю.', '2022-12-12', 'Что будет, если не работать?', 38, '73fec3a3-6970-4933-be0e-3e6a6423f5cc.coffin_dance.jpg'),
        ('11111111', 'Напоминаем нашим дорогим сотрудникам, что собрание литературного клуба уже в этот четверг. Мы искренне надеемся, что все уже прочитали "Война и мир" Льва Николаевича Толстого. ', '2022-12-12', 'Собрание книжного клуба в четверг', 39, 'f737f027-4ba7-4d76-8859-17e70238e420.literature_club.png'),
        ('11111111', 'Мы рады сообщить нашим сотрудникам, что мы вернули кулеры обратно в офисы. Теперь вам не придется выпрашивать воду у наших соседей по зданию!', '2022-12-12', 'Вода снова в ваших офисах!', 40, 'f5e953b1-f6ed-4185-b0a3-e18c10023832.kuler.jpg'),
        ('11111111', 'Семинар по межличностным коммуникациям.', '2022-12-12', 'Новый семинар уже в эту пятницу!', 41, '997dadb6-fdb7-47e9-9031-66d0f30712f0.seminar.jpg'),
        ('11111111', 'Семинар по правам человека.', '2022-12-12', 'Новый семинар уже в эту субботу!', 42, '997dadb6-fdb7-47e9-9031-66d0f30712f0.seminar.jpg');